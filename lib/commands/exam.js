...
module.exports = TestCommand.extend({
  ...
  /**
   * Overrides ember-cli's transformOptions (for testem).
   *
   */
  transformedOptions(options) {
    let transformed = this._super.transformedOptions.apply(this, [options])
  ...
  _generateCustomConfigs(commandOptions) {
    ...
    config.parallel = config.testPage.length;
