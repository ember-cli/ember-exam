...
function getBrowserId(testPage) {
  ...
  if (Array.isArray(browserId) !== null && browserId !== null) {
    ...
    // TODO: previously, this throws an error, if we return 0, it may hide the problem, rethink this more
    return 0;
  }
}
...
function getMultipleTestPages(config, commandOptions) {
  ...
  let browserIds = convertOptionValueToArray(commandOptions.partition);
