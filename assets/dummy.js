...
;define("dummy/templates/application", ["exports"], function (_exports) {
  ...
  var _default = Ember.HTMLBars.template({
    "id": "pLTeTW8C",
    "block": "{\"symbols\":[],\"statements\":[[1,[23,\"outlet\"],false],[0,\"\\n\\n\"],[1,[23,\"docs-keyboard-shortcuts\"],false]],\"hasEval\":false}",
    "meta": {
...
;define("dummy/templates/docs/filtering", ["exports"], function (_exports) {
  ...
  var _default = Ember.HTMLBars.template({
    "id": "Do8x22SU",
    "block": "{\"symbols\":[],\"statements\":[[7,\"div\"],[11,\"class\",\"docs-md\"],[9],[7,\"h3\"],[11,\"id\",\"filtering\"],[11,\"class\",\"docs-md__h3\"],[9],[7,\"a\"],[11,\"href\",\"#filtering\"],[11,\"class\",\"heading-anchor\"],[9],[0,\"Filtering\"],[10],[10],[0,\"\\n    \"],[7,\"p\"],[9],[0,\"Ember Exam provides options to filter test suites by two types - module path and test file path.\"],[10],[0,\"\\n\"],[7,\"pre\"],[11,\"class\",\"docs-md__code\"],[9],[7,\"code\"],[11,\"class\",\"undefinedbash\"],[9],[0,\"$ ember exam --module-path=<module-path>\"],[10],[10],[0,\"\"],[7,\"p\"],[9],[0,\"The \"],[7,\"code\"],[9],[0,\"module-path\"],[10],[0,\" option allows you to filter module paths by a given value. Module paths are mapped by test files and they are generated during \"],[7,\"code\"],[9],[0,\"ember build\"],[10],[0,\". After the build, \"],[7,\"code\"],[9],[0,\"tests.js\"],[10],[0,\" file is created and it resides under [build-directory]/assets. The file is combined of all tests in an application and it has a form of \"],[7,\"code\"],[9],[0,\"define(\\\"<module-path>\\\", others..\"],[10],[0,\".\"],[10],[0,\"\\n\"],[7,\"p\"],[9],[0,\"The value for \"],[7,\"code\"],[9],[0,\"module-path\"],[10],[0,\" can have either string or regular expression, for instance:\"],[10],[0,\"\\n\"],[7,\"pre\"],[11,\"class\",\"docs-md__code\"],[9],[7,\"code\"],[11,\"class\",\"undefinedbash\"],[9],[0,\"# When module path value is string. This will run all modules which match with the passed value\\n$ ember exam --module-path='dummy/tests/helpers/module-for-acceptance'\\n\\n# When module path value is regex. This will run all modules which have `dummy` in it\\n$ ember exam --module-path='!/dummy/'\"],[10],[10],[0,\"\"],[7,\"p\"],[9],[0,\"The \"],[7,\"code\"],[9],[0,\"file-path\"],[10],[0,\" option is to filter tests by \"],[7,\"em\"],[9],[0,\"test file path\"],[10],[0,\". The test file path is a location of the test file in a file system. You can specify \"],[7,\"code\"],[9],[0,\"file-path\"],[10],[0,\" to a location of specific test file path or you can use wildcards in paths to target multiple test files.\"],[10],[0,\"\\n\"],[7,\"pre\"],[11,\"class\",\"docs-md__code\"],[9],[7,\"code\"],[11,\"class\",\"undefinedbash\"],[9],[0,\"# This will run tests that are defined in `/my-application/tests/unit/my-test.js`\\n$ ember exam --file-path='/my-application/tests/unit/my-test.js'\\n\\n# This will run all test files that are under `/my-application/tests/unit/`\\n$ ember exam --file-path='/my-application/tests/unit/*.js'\"],[10],[10],[10]],\"hasEval\":false}",
    "meta": {
...
;define("dummy/templates/not-found", ["exports"], function (_exports) {
  ...
  var _default = Ember.HTMLBars.template({
    "id": "yAjnOAYi",
    "block": "{\"symbols\":[\"viewer\"],\"statements\":[[1,[23,\"docs-header\"],false],[0,\"\\n\\n\"],[4,\"docs-viewer\",null,null,{\"statements\":[[0,\"  \"],[1,[24,1,[\"nav\"]],false],[0,\"\\n\\n\"],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,1,[\"main\"]],\"expected `viewer.main` to be a contextual component but found a string. Did you mean `(component viewer.main)`? ('dummy/templates/not-found.hbs' @ L6:C5) \"],null]],null,{\"statements\":[[0,\"    \"],[7,\"div\"],[11,\"class\",\"docs-container\"],[9],[0,\"\\n      \"],[7,\"h1\"],[9],[0,\"Not found\"],[10],[0,\"\\n      \"],[7,\"p\"],[9],[0,\"This page doesn't exist. \"],[4,\"link-to\",null,[[\"route\"],[\"index\"]],{\"statements\":[[0,\"Head home?\"]],\"parameters\":[]},null],[10],[0,\"\\n    \"],[10],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[1]},null]],\"hasEval\":false}",
    "meta": {
